if( GAUXC_HAS_CUDA )
  ...
  if( CUDAToolkit_VERSION VERSION_LESS "11.0.0" )
    ...
    if(GAUXC_OFFLINE_BUILD)
      message(STATUS "GAUXC_OFFLINE_BUILD enabled - skipping remote download of CUB")
      message(FATAL_ERROR "CUB is required but GAUXC_OFFLINE_BUILD is enabled and CUDAToolkit version < 11.0.0. "
                          "Please install CUB system-wide, upgrade CUDAToolkit to >= 11.0.0, or disable GAUXC_OFFLINE_BUILD.")
    else()
